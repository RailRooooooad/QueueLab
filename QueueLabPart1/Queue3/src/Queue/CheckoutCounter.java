...
public class CheckoutCounter 
{
    ...
    public void addCustomer(Customer customer, int currentTime)
    {
        ...
        // Update total wait time and statistics
        totalWaitTime += waitTime;
        totalCustomers++;
        totalItemsProcessed += customer.getItems();
        
        // Update the maximum queue length if the current queue is longer
    ...
    public void processCustomers(int currentTime)
    {
        ...
        {
    		// Remove the customer from the queue as they have been processed
    		queue.poll();
        }
        freeTime++;
    }
